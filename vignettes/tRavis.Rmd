...
and toggle a theshold line at a given number of reads/counts:
```{r tr_qc_plots, warning=FALSE, fig.show='hold', fig.width=8}
...
All underlying data is also returned, so one can easily generate their own plots
if further refinements are required. 
