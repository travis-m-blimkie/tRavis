...
#'   export the data for "fastqc_per_base_sequence_quality_plot" as a
#'   tab-delimited file (TSV), placing it inside the same directory as the rest.#'
#'
...
tr_qc_plots <- function(directory) {
  ...
  qc_theme <- theme_bw(base_size = 18) +
