...
#' @param hide_samples Logical: For `type = "bar"`, remove samples names from
#'   the y axis when there are many samples. Defaults to FALSE.
#' @param col_width Width of bars when `type = "bar"`, which can be reduced when
