#' tr_de_results
#'
#' @param dds_obj A DESEq2 dataset object as produced by running DESeq2::DESeq()
#' @param col_name he name of the column/variable being analyzed, e.g.
...
#' @param denominatorThe baseline or control condition used in the DE
...
#' @export
#'
#' @description This function runs DESeq2::results() using the contrast argument
#'   and levels specified by the user. It also adds columns for absolute log2
#'   fold change and fold change, and filters the result based on user-provided
#'   cutoffs for adjusted p-value and log2 fold change.
#'
#' @references None.
#'
...
tr_de_results <- function(dds_obj,
  ...
  deseq2_result <- results(object = dds_obj,
